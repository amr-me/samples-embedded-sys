...
// Subroutine reads AS input "PF4" and waits for signal to be low
...
// Subroutine clears VT low PF1 = 0
// Inputs:  None
// Outputs: None
// Notes:   friendly means it does not affect other bits in the port
void ClearVT(void)
...
// Subroutine sets Ready high PF3 = 1
// Inputs:  None
// Outputs: None
// Notes:   friendly means it does not affect other bits in the port
void SetReady(void)
...
// Subroutine clears Ready low PF3 = 0
// Inputs:  None
// Outputs: None
// Notes:   friendly means it does not affect other bits in the port
void ClearReady(void)
